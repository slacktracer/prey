export const addCracksToTextureFunctions = [
  // Crack type 1: Jagged random cracks with multiple segments
  ...
  // Crack type 2: Branched cracks with a main line and random branches
  ({ context }: { context: CanvasRenderingContext2D }) => {
  ...
  // Crack type 3: Circular cracks with radiating lines
  ({ context }: { context: CanvasRenderingContext2D }) => {
